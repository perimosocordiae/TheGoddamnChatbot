...
from tgdcb.cmds import backticks
...
if ROOM_TYPE == 'MUC':
    ...
    while mucroombot.main(lambda: MucEvalClient(JID(jidname),getpass(),BOT_NAME)): pass
elif ROOM_TYPE == 'IRC':
    while ircbot.main(lambda: IrcEvalClient(BOT_NAME)): pass
# vi: sts=4 et sw=4
